...
import com.example.im_spring20230920.domain.MyDto36;
...
// CDATA : character data : 문자로만 판단, 마크업코드해석X
    // 동적 쿼리를 만들려면 스크립트 안에 넣기위함 ( 오류방지 )
    @Select("""
<script>
<![CDATA[
SELECT *
...
// prefix = trim안에 내용물이 있을 때엔 붙는다
// prefixOverride = 무조건 붙인다